...
class TemporalConvNet(PytorchModelBase):
    @staticmethod
    ...
    def __init__(self, num_channels, num_levels, kernel_size=2, dropout=0.2, **kwargs):
        ...
        self.fc = nn.Linear(in_features=num_channels[-1], out_features=self.output_size, bias=True)
    ...
    def forward(self, x, hidden, context):
        ...
        return fc_out[:, -out_size:, :].contiguous(),  hidden
